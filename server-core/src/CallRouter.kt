...
class CallRouter(
	...
	fun routeAuthorizationCodeRedirect(callContext: CallContext, credentials: Credentials?): RedirectRouterResponse {
	...
	fun routeAccessTokenRedirect(callContext: CallContext, credentials: Credentials?): RedirectRouterResponse {
		val queryParameters = callContext.queryParameters
